import csv
from decorator import bd_connection, logger
...
def money_transfer(cursor, sender_account_id, receiver_account_id, amount, transaction_datetime=None):
    ...
    try:
        ...
        sender_currency, sender_balance, sender_account_number, sender_bank_id = sender_result
        ...
        receiver_currency, receiver_account_number, receiver_bank_id = receiver_result
